...
- Install [tmux](https://github.com/tmux/tmux): `$ brew install tmux`
...
- Install [Rust](https://www.rust-lang.org): `$ curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh`
- Install [rust-analyzer (Rust LSP)](https://github.com/rust-lang/rust-analyzer): `$ curl -L https://github.com/rust-lang/rust-analyzer/releases/latest/download/rust-analyzer-x86_64-unknown-linux-gnu.gz | gunzip -c - > rust-analyzer && chmod u+x rust-analyzer && sudo mv rust-analyzer /usr/local/bin`
- Install [Clippy](https://github.com/rust-lang/rust-clippy): `$ rustup component add clippy`
- Install [Cargo Watch](https://github.com/watchexec/cargo-watch): `$ cargo install cargo-watch`
- Install [bacon](https://github.com/Canop/bacon): `$ cargo install --locked bacon`
...
- Install [Go 1.21](https://go.dev): `$ GO_DOWNLOAD="go1.21.0.linux-amd64.tar.gz"; curl "https://go.dev/dl/${GO_DOWNLOAD}" -OL && sudo rm -rf /usr/local/go && sudo tar -C /usr/local -xzf ${GO_DOWNLOAD} && rm ${GO_DOWNLOAD}`
- Install [gopls (Go LSP)](https://pkg.go.dev/golang.org/x/tools/gopls): `$ go install golang.org/x/tools/gopls@latest`
- Install [staticcheck](https://github.com/dominikh/go-tools): `$ go install honnef.co/go/tools/cmd/staticcheck@latest`
- Install [Delve (Go debugger)](https://github.com/go-delve/delve): `$ go install github.com/go-delve/delve/cmd/dlv@latest`
...
- Install [vscode-language-servers-extracted (LSP)](https://www.npmjs.com/package/vscode-langservers-extracted): `$ npm install -g vscode-langservers-extracted`
- Install [typescript-language-server](https://www.npmjs.com/package/typescript-language-server) (including for JavaScript)
- Install [Biome](https://biomejs.dev): `$ npm install -g @biomejs/biome`
...
- Install [bash-language-server (Bash LSP)](https://github.com/bash-lsp/bash-language-server): `$ npm install -g bash-language-server`
- Install [shfmt](https://github.com/mvdan/sh): `$ go install mvdan.cc/sh/v3/cmd/shfmt@latest`
- Install [ShellCheck](https://github.com/koalaman/shellcheck): `$ sudo apt install shellcheck`

#### Markdown

- Install [Marksman (Markdown LSP)](https://github.com/artempyanykh/marksman): `$ curl -L https://github.com/artempyanykh/marksman/releases/download/2023-07-01/marksman-linux-x64 -o marksman && chmod +x marksman && sudo mv marksman /usr/local/bin`
...
- Install [tmux](https://github.com/tmux/tmux): `$ sudo apt install tmux`
- Install [Prettier](https://github.com/prettier/prettier) globally: `$ npm install -g prettier`
- Install [delta](https://github.com/dandavison/delta): `$ cargo install git-delta`
- Install [exa](https://github.com/ogham/exa#installation): `$ sudo apt install exa`
- Install [ripgrep](https://github.com/BurntSushi/ripgrep): `$ sudo apt install ripgrep`
- Install [bat](https://github.com/sharkdp/bat): `$ sudo apt install bat && sudo ln -s $(which batcat) /usr/local/bin/bat`
- Install [fzf](https://github.com/junegunn/fzf): `$ sudo apt install fzf`
- Install [fd](https://github.com/sharkdp/fd): `$ sudo apt install fd-find && sudo ln -s $(which fdfind) /usr/local/bin/fd`
...
- Install [glow](https://github.com/charmbracelet/glow): `$ go install github.com/charmbracelet/glow@latest`
- Install [broot](https://dystroy.org/broot): `$ cargo install broot && broot`
- Install [xh](https://github.com/ducaale/xh): `$ cargo install xh`
- Install [bottom](https://github.com/ClementTsang/bottom): `$ cargo install bottom`
- Install [tldr](https://github.com/tldr-pages/tldr): `$ npm install -g tldr`
- Install [hecate](https://github.com/evanmiller/hecate): `$ go install github.com/evanmiller/hecate@latest`
- Install [dog](https://github.com/ogham/dog): `$ curl -LO https://packages.azlux.fr/debian/pool/main/d/dog/dog_0.1.0_amd64.deb && sudo dpkg -i dog_0.1.0_amd64.deb && rm dog_0.1.0_amd64.deb`
- Install [procs](https://github.com/dalance/procs): `$ cargo install procs`
- Install [dust](https://github.com/bootandy/dust): `$ curl -L -o dust.gz https://github.com/bootandy/dust/releases/download/v0.8.3/dust-v0.8.3-i686-unknown-linux-gnu.tar.gz && tar -xvf dust.gz && sudo mv dust-v0.8.3-i686-unknown-linux-gnu/dust /usr/local/bin && rm -rf dust-v0.8.3-i686-unknown-linux-gnu && rm dust.gz`
- Install [duf](https://github.com/muesli/duf): `$ sudo apt install duf`
- Install [tokei](https://github.com/XAMPPRocky/tokei): `$ cargo install tokei`
- Install [killport](https://github.com/jkfran/killport): `$ cargo install killport`

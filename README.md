...
- Install [sheldon](https://github.com/rossmacarthur/sheldon) shell plugin manager: `$ cargo install sheldon`
- Install [Starship](https://github.com/starship/starship) shell prompt: `$ curl -sS https://starship.rs/install.sh | sh`
